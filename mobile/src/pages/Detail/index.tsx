        ...
        <SafeAreaView style={{ flex: 1 }}>
            <View style={styles.container}>
                ...
                <Image 
                    ...
                    source={{ uri: 'https://images.unsplash.com/photo-1545601445-4d6a0a0565f0?ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=60' }}
                />
                <Text style={styles.pointName}>Mercado</Text>
                <Text style={styles.pointItems}>Lâmpadas, Óleo</Text>

                <View style={styles.address}>
                    <Text style={styles.addressTitle}>Enderesso</Text>
